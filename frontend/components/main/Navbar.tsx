    ...
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-10 ">
      <div className="w-max-[1284px] h-full flex flex-row items-center justify-between m-auto">
        ...
        <div className="flex gap-5 cursor-pointer">
          <button className="w-10 h-10 flex items-center justify-center rounded-lg bg-transparent border border-[#7042f861] shadow-md group transition-all duration-300">
            <svg
          ...
          <button className="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-white shadow-md group transition-all duration-300">
            <svg
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md group transition-all duration-500">
            <svg
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-full bg-white shadow-md group relative overflow-hidden transition-all duration-300">
            <svg
