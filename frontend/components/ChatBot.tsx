...
//   return (
//     <div className="flex flex-col h-[600px] w-[400px] max-w-2xl mx-auto bg-gradient-to-b from-transparent rounded-xl shadow-2xl border border-gray-100">
//       <div className="flex items-center justify-between p-4 bg-gradient-to-r from-transparent border-b rounded-t-xl">
...
//         className="p-4 bg-transparent border-t border-gray-100 rounded-b-xl"
//       >
//         <div className="flex items-center space-x-2">
//           <input
//             type="text"
...
//             className="flex-1 p-3 rounded-xl border border-gray-200 bg-transparent text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm placeholder:text-gray-400"
//             disabled={loading}
//           />
//           <button
//             type="submit"
